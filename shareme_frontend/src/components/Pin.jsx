...
const Pin = ({pin:{postedBy,image,_id,_destination,save}}) => {
    ...
    <div className='m-2'>
      ...
      <Link to={`/user-profile/${postedBy?._id}`} className="flex gap-2 mt-2 items-center">
        <img
          ...
          alt="user-profile"
        />
        <p className="font-semibold capitalize">{postedBy?.userName || 'Loading...'}</p>
      </Link>
    </div>
  )
}
